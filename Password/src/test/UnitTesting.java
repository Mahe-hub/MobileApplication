...
public class UnitTesting {
	...
	public void test() {
		//fail("Not yet implemented");
		 String output_f= obj1.isSame("", bookTest);
		 //test the output
		 assertEquals("",output_f);
	...
	{
		boolean	output_f=obj1.isAllpresentLower("JustthentheWhite");
	...
	{
		int output_f=obj1.isAllpresentSpecial("$Justthent");
	...
	{
		boolean	output_f=obj1.isAllpresentUpper("was a table");
